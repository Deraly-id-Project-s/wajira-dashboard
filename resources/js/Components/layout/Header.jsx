    ...
    <>
      ...
      {showSearchModal &&
        ReactDOM.createPortal(
          ...
          >
            <div className="bg-white w-[90%] md:w-[600px] rounded-xl shadow-lg overflow-hidden max-h-[80vh] flex flex-col">
              ...
              <div id="search-modal" className="overflow-y-auto p-4 flex-1">
                {isSearching ? (
                  ...
                  searchResults.map((item, index) => (
                    ...
                    >
                      <img
                        src={`/storage/${item.product_image && item.product_image !== "undefined"
                            ? item.product_image
                            : item.image
                          }`}
                        alt={item.name}
