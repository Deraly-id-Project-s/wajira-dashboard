...
const ExpeditionCard = ({ lang }) => {
  ...
  return (
    <section id="expedition" className="w-full flex flex-col justify-center align-middle items-center">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10 md:gap-16 py-12 md:px-0 px-[10px]">
        {/* Left - Image */}
      ...
      <div className="w-full">
        {/* <img src="/assets/products/expeditions/truck_1.png" className="rounded-md flex-1 object-cover max-h-[22rem]" alt="" />
        <img src="/assets/products/expeditions/truck_2.png" className="rounded-md flex-1 object-cover max-h-[22rem]" alt="" />
        <img src="/assets/products/expeditions/truck_3.png" className="rounded-md flex-1 object-cover max-h-[22rem]" alt="" /> */}
        <VideoPlayer />
      </div>
    </section>
  );
