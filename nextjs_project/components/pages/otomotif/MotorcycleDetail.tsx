...
const HomePage = ({ slug }: MotorcycleDetailProps) => {
  // State for the currently selected category
  const [activeCategory, setActiveCategory] = useState("/product/otomotif/" + slug);
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 3D Viewer Section */}
      <section id="viewer-section" className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center">
            360 Preview
          </h2>
