...
function getMotorcycleVariants(slug: string) {
    switch (slug) {
        case 'aerox-alpha':
            return [
                {
                    ...
                    color: '#000000',
                    price: 'Rp 67.965.000',
                    image: '/assets/motorcycle/360/aerox-alpha/colors/black.png',
                },
                {
                    name: 'Dark Blue Venom',
                    color: '#0000A0',
                    price: 'Rp 67.965.000',
                    image: '/assets/motorcycle/360/aerox-alpha/colors/darkblue.png',
                },
                {
                    name: 'Luxury Red',
                    color: '#FF0000',
                    price: 'Rp 67.965.000',
                    image: '/assets/motorcycle/360/aerox-alpha/colors/red.png',
                },
                {
                    name: 'Prestige Silver',
                    color: '#C0C0C0',
                    price: 'Rp 67.965.000',
                    image: '/assets/motorcycle/360/aerox-alpha/colors/silver.png',
                },
            ];
            break;
        case 'lexi-lx-155':
...
const MotorcycleColor = ({ slug }: HeroSectionProps) => {
    const [selectedIndex, setSelectedIndex] = useState(0);

    const motorcycleVariants = getMotorcycleVariants(slug || '');
    ...
    return (
        <section
            className="relative max-w-5xl mx-auto py-16 px-4 text-center rounded-xl"
